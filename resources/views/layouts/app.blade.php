...
<body>
    ...
    <nav class="navbar navbar-light bg-light">
        ...
        <h4 class="ml-auto" style="font-weight:600; color:green; font-style: italic; padding-top:10px">- KHELILI AUTO
            CAR SLOT -</h4>
            ...
            @if (auth()->check())
                ...
                @else
                  ...
                  document.getElementById('logout-form').submit();"><i
                                class="fa fa-sign-out fa-lg mr-1" aria-hidden="true"></i>Log Out</a>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                    @endif
                @endif
            @else
                <a class="nav-link text-dark" href="{{ route('login') }}"><i class="fa fa-sign-in fa-lg mr-1"
    ...
    <header class="navbar navbar-expand-lg navbar-dark bg-secondary">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @foreach ($categories as $category)
                            <a class="dropdown-item"
                                href="{{ route('category_products', $category) }}">{{ $category->name }}</a>
                        @endforeach
                    </div>
                </li>
            ...
            <form class="form-inline my-2 my-lg-0" type="get" enctype="multipart/form-data"
                action="{{ route('search_products') }}">
                @csrf
                <input class="form-control mr-sm-2" name="query" type="search" placeholder="Search Products Here"
                    aria-label="Search">
        ...
        @if (Auth::user())
            <a class="nav-link text-light" href="{{ route('cart') }}" tabindex="-1" aria-disabled="true">
                <i class="fa fa-shopping-bag fa-lg"><span
                        class="badge badge-light ml-1">{{ count(auth()->user()->cart) }}</span> </i></a>
        @else
            <a class="nav-link text-light" href="{{ route('login') }}" tabindex="-1" aria-disabled="true"><i
        ...
        <div class="container p-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 pr-5 mb-4 mb-md-0">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2921.4176515727513!2d20.81315060069665!3d42.92732132818893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDLCsDU1JzM4LjQiTiAyMMKwNDgnNTIuMCJF!5e0!3m2!1ssr!2srs!4v1633445151361!5m2!1ssr!2srs"
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="pt-3">
                            <a href="#!" class="text-white pt-3"> <i class="fa fa-envelope pr-1"></i>
                                KHELILI@gmail.com</a>
                        </li>
                        <li class="pt-3">
                            <a href="#!" class="text-white"> <i class="fa fa-map-pin pr-1"></i> new Era, Doljane
                                BB</a>
                        </li>
                        <li>

    ...
    <div class="container">
        ...
        <div class="row m-5">
            ...
            <div class="col mt-3">
                ...
                <p><strong>Kategorija:</strong><a href="{{ route('category_products', $product->category) }}">
                        {{ $product->category->name }}</a></p>
                <p><strong>Brend:</strong><a href="{{ route('brand_products', $product->brand) }}">
                        {{ $product->brand->name }} </a></p>
                <p><strong>Tip vozila:</strong> <a href={{ route('vehicle_type_products', $product->vehicle_type) }}>
                ...
                <div class="row d-flex mt-3">
                    ...
                    <a href="{{ route('create_purchase', $product) }}"> <button class="btn btn-danger">Kupi
                            Odmah</button></a>
                </div>
            </div>
        </div>
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column ml-3">
                                <div class="d-flex flex-row post-title  ">
                                    <h5>{{ $product->name }}</h5> <span class="ml-2 mt-">U nasoj e-prodavnici od
                                        {{ $product->created_at->format('Y-m-d') }}</span>
                                </div>
                                <div class="d-flex flex-row align-items-center align-content-center post-title"><span
                                        class="mr-2 comments">{{ count($product->comment) }} Komentara</span></div>
                            </div>
                        </div>
                        <div class="coment-bottom bg-white p-2 px-4">
                            ...
                            <div class="collapsable-comment">
                                <div class="d-flex flex-row justify-content-between align-items-center action-collapse p-2"
                                    ...
                                    href="#collapse-1">
                                    <span>Komentari</span><i class="fa fa-chevron-down servicedrop"></i>
                                </div>

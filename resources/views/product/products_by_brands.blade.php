        ...
        <div class="row">
            <div class="alert ">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Pozdrav korisnice </strong>Ovde mozes listati sve produkte koje ce te mozda zainteresovati.
                    Veliki asortiman produkta ce ti pomoci da pronadjes neke nove dodatke za tvoje vozilo
                        ...
                        <div class="card-body">
                            ...
                            @if (auth()->user())
                                <form action="{{ route('cart.store') }}" enctype="multipart/form-data" method="post">
                                    ...
                                    @else
                                        <button class="btn btn-outline mr-2" type="submit">Add to Cart</button>
                                    @endif

                                </form>
                            @else
                                <a href="{{ route('login') }}"><button class="btn btn-primary mr-2">Dodaj u
                                        korpi</button></a>
                            @endif
                        </div>
